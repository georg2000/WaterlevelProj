...
cant_listRiverAll = ['BAS', 'MOE', 'LFB', 'GOE', 'BUS', 'SNG', 'BEZ', 'LEI', 'DIT', 'LGA', 'OPF', 'ZHNIE', 'BUE', 'ZHMON', 'UST', 'BAM', 'ALW', 'ZHTUR', 'ZHZEL', 'WIN', 'AFI', 'NIE', 'FRF', 'SHA', 'DIE', 'ESZ', 'STG', 'APP', 'EBK']
cant_list = ['ARI', 'BAS', 'LAF', 'MOE', 'RUE', 'EPT']

#Here the best set of precipitation measurement stations is givan but could be changed, as well as lag.
df = Create_lag_df.create_df_shift(['ARI', 'BAS', 'LAF', 'MOE', 'RUE', 'EPT'], 30, "rre150d0", "Data_Precipitation/Precip_1990-2020_day_all/order_ARI_rre150d0_1_data.txt")
print("dfn:\n", df)

df_waterlts = Conv_Wasserstand.convert_waterlevel("Data_Waterlevel/2091_Pegel_Stundenmittel_1974-01-01_2020-03-01.csv", "days")[1]
...
df_ts_wl = datex(df_waterlts,'1990-02-01', '2020-01-01')
df_tf = datex(df,'1990-02-01', '2020-01-01')
...
#prepare for plot
index = pd.date_range(start=pd.Timestamp('1990-02-02'), end=pd.Timestamp('2020-01-01'))
